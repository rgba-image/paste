...
exports.pasteDarken = void 0;
const common_1 = require("@rgba-image/common");
const pasteDarken = (source, dest, sx = 0, sy = 0, sw = source.width - sx, sh = source.height - sy, dx = 0, dy = 0, sourceAlpha = 1) => {
    sx = sx | 0;
    sy = sy | 0;
    sw = sw | 0;
    sh = sh | 0;
...
exports.pasteDarken = pasteDarken;
//# sourceMappingURL=paste-darken.js.map